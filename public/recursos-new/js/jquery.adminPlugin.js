...
;(function($) {
    ...
    function Plugin(element, options) {
        ...
        function sidebarNav () {
            ...
            subs.each(function(index, el) {
                $(this).prev('a').prepend('<i class="nav-sub-indicator fa fa-angle-down"></i>');
            });
            ...
            link.click(function(event) {
                ...
                if (_this.next('.sub-nav').length > 0 && !_this.next('.sub-nav').hasClass('sub-open')) {
                    ...
                    _this.find('.nav-sub-indicator').removeClass('rotate0').addClass('rotateM180');
                ...
                if (_this.next('.sub-nav').length && _this.next('.sub-nav').hasClass('sub-open')) {
                    ...
                    _this.find('.nav-sub-indicator').removeClass('rotateM180').addClass('rotate0');                
                }
            });
        }
        ...
        function leftSidebarHide (state) {
            ...
            if (state) {
                ...
                var _view = $(window);
                if(_view.width() <= 767) {
                    $('.left-sidebar').addClass('left-sidebar-hover');
                }
                */
            }
        }
    ...
    */
    ...
    $.fn[pluginName].defaults = {
        ...
        niceScroll: {
            cursorcolor: "#879ca6", // change cursor color in hex
