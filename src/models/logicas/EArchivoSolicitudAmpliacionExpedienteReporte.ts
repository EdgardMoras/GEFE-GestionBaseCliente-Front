...
export default class EArchivoSolicitudAmpliacionExpedienteReporte {
  public ID: number;
  public Title: string;
  ...
  public SolicitudAmpliacionReporte: Lookup;
  ...
  constructor() {
    ...
    this.SolicitudAmpliacionReporte = new Lookup();
    this.Eliminar = false;
  }
  ...
  public obtenerDatos(file: any) {
    ...
    this.SolicitudAmpliacionReporte.ID = Util.ObtenerEntero(
      file.ListItemAllFields.SolicitudAmpliacionReporteId
    );
