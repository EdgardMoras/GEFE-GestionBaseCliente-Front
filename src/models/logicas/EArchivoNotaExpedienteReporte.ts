...
export default class EArchivoNotaExpedienteReporte {
  public ID: number;
  public Title: string;
  ...
  public IdNotaExpedienteReporte: Lookup;
  ...
  constructor() {
    ...
    this.FechaRegistro = "";
    this.RegistradoPor = "";
    this.IdNotaExpedienteReporte = new Lookup();
  ...
  public obtenerDatos(file: any) {
    ...
    this.IdNotaExpedienteReporte.ID = Util.ObtenerEntero(
      file.ListItemAllFields.IdNotaExpedienteReporteId
    );
